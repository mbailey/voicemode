...
.PHONY: help install dev-install clean \
	...
	docs-serve docs-build docs-check docs-deploy serve-web \
...
help:
	...
	@echo "  serve-web     - Serve getvoicemode.com website locally (http://localhost:8080)"
	@echo ""
...
# Serve getvoicemode.com website locally
serve-web:
	@echo "Starting getvoicemode.com website at http://localhost:8080..."
	@echo ""
	@echo "Website includes LiveKit embeddable voice assistant"
	@echo "Press Ctrl+C to stop the server"
	@echo ""
	@cd docs/web && python3 -m http.server 8080
