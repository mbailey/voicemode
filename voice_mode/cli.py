...
@click.option('--debug', is_flag=True, help='Show transcribed text for debugging')
def listen(wake_word, daemon, config, no_tts, no_viz, debug):
    ...
    if debug:
        click.echo("🐛 Debug mode - will show transcribed text")
