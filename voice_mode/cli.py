...
@click.option('--return-when', type=click.Choice(['complete', 'audio_starts', 'audio_generated']), default='complete',
              help='When to return control: complete (wait for playback), audio_starts (return immediately), audio_generated (return after TTS)')
...
def converse(message, wait, duration, min_duration, transport, room_name, voice, tts_provider,
            ...
            speed, vad_aggressiveness, skip_tts, return_when, continuous):
