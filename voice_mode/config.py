...
def load_voicemode_env():
    ...
    if not new_config_path.exists() and old_config_path.exists():
        # Read from old location if it exists and new doesn't
        config_path = old_config_path
    
    # Create new config only if neither exists
    if not new_config_path.exists() and not old_config_path.exists():
        # Create default template at new location
...
'''
        ...
        os.chmod(new_config_path, 0o600)  # Secure permissions
